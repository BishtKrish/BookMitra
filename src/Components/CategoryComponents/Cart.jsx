...
import CheckoutForm from "../CategoryComponents/CheckoutForm";

const stripePromise = loadStripe("pk_test_51PuemNP4JAHlJSKiBPeHTgGqsTsBulkjtZjWIR942c8N50VkGKQNXcEHKDDg62Nezy9HpIQMdZSEUri7nG81uZtu00kvAdICF7");
                                            ...
                                            <tr key={item._id} className="border-none">
                                                ...
                                                <td>
                                                    <div className="flex gap-2 items-center">
                                                        <button onClick={() => decreaseQuantity(item._id)} className="btn btn-ghost btn-xs">-</button>
                                                        <span className="px-4 py-2 bg-gray-100 text-gray-800 rounded-lg">{item.quantity}</span>
                                                        <button onClick={() => increaseQuantity(item._id)} className="btn btn-ghost btn-xs">+</button>
                                                    </div>
                                                </td>
