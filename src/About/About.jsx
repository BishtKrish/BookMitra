    ...
    <Navbar/>
      <div className="max-w-screen-2xl container mx-auto mt-[68px] px-4 md:px-20">
        ...
        <div className="w-full p-2 mt-5">
         ...
         <p className="text-[16px] md:text-[17px] pt-5  text-justify dark:text-slate-300"><strong className="text-[18px]">BookMitra</strong> is a family-owned chain of nationwide bookstores. Our journey began in 1980 with a kiosk in old city. Today we stand with a national network of artisanal bookstores and a personalized online experience serving pan Pakistan.
          </p>
