      ...
      <section className="text-center py-12 px-4 mt-20" >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 animate-fadeIn">
          <div className="p-4 shadow-lg rounded-lg bg-blue-100 hover:bg-blue-200  dark:bg-slate-700 transition-colors">
            ...
            <p className="text-gray-700 mt-2  dark:text-slate-300">+91 123 456 7890</p>
          </div>
          <div className="p-4 shadow-lg rounded-lg bg-blue-100 hover:bg-blue-200  dark:bg-slate-700 transition-colors">
            <h3 className="text-xl font-bold">Email Us</h3>
            <p className="text-gray-700 mt-2 dark:text-slate-300">query@bookmitrastore.com</p>
          </div>
          <div className="p-4 shadow-lg rounded-lg bg-blue-100 hover:bg-blue-200  dark:bg-slate-700 transition-colors">
            <h3 className="text-xl font-bold">Visit Us</h3>
            <p className="text-gray-700 mt-2 dark:text-slate-300"> Dehradun , Uttarakhand</p>
          </div>
        </div>
      </section>
